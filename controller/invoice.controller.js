...
//     // Query the database to find all invoices associated with the employee
//     const invoices = await Invoice.findOne({ createdBy: employeeId });
